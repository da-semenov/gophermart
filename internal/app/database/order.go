...
const CreateOrder = "INSERT INTO practicum.orders (id, user_id, num, status, upload_at, updated_at) VALUES(nextval('seq_order'),  $1, $2, $3, $4, $5);"

const UpdateOrderStatus = "UPDATE practicum.orders SET status=$3, updated_at=CURRENT_TIMESTAMP where user_id=$1 and num=$2 and status!=$3;"
